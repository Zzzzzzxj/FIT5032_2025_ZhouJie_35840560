...
const submitForm = () => {
  ...
  validateConfirmPassword(true) // Add this to validate on submit
  validateReason() // Add this to validate on submit
...
const clearForm = () => {
  formData.value = {
    username: '',
    password: '',
    confirmPassword: '', // Clear confirmPassword too
    isAustralian: false,
    reason: '',
    gender: ''
  }
  // Clear all errors when clearing the form
  errors.value = {
    username: null,
    password: null,
