  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- Activity 9: Render a list of Austen's works. Hint: Use the v-for directive to iterate through the array of authors that you have filtered out. -->
       <ul>
        <li v-for="(work, id) in austen?.famousWorks" :key="id">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="([type, count], id) in Object.entries(bookstores.storeTypes)" :key="id">
          {{ type }}: {{ count }} store<span v-if="count > 1">s</span>
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="author in authors" :key="author.id">
          <p v-if="author.name.includes('George Orwell')" 
          v-bind:style="{color: highlightColor, fontSize: highlightSize}">
            {{ author.name }}
          </p>
...
const highlightColor = ref("#62b993")
const highlightSize = ref("1.4rem")
</script>
